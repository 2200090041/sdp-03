...
def flight(request):
    ...
    if trip_type == '2':
        ...
        if returndate is not None:
            ...
            # Handle the case when returndate is None
            # For example, set a default return_date or return an error message
            return_date = None  # Set a default value or handle the None case accordingly
